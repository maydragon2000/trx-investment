                            ...
                            <div className="wrap-heading flat-slider flex">
                                <div className="content">
                                    ...
                                    <div className="flat-bt-slider flex style2">
                                        <a href="#deposit" className="sc-button header-slider style style-1 note fl-button pri-1"><span>Deposit
                                        </span></a>
                                        <a href="#withdraw" className="sc-button header-slider style style-1 bag fl-button pri-1"><span>Withdraw
                                        </span></a>
                                    </div>
                                </div>
                                <div className="image">
